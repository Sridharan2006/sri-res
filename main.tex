...
\begin{center}
    ...
    \small \faPhone* \texttt{'2'} \hspace{1pt} $|$
    \hspace{1pt} \faEnvelope \hspace{2pt} \texttt{'3'} \hspace{1pt} $|$ 
    \hspace{1pt} \faYoutube \hspace{2pt} \texttt{'4'} \hspace{1pt} $|$
    \hspace{1pt} \faMapMarker* \hspace{2pt}\texttt{'5'}
    \\ \vspace{-3pt}
\end{center}
